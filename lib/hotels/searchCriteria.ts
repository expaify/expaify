...
export function buildHotelResultsUrl(
  ...
  if (view?.minDiscount !== undefined && view.minDiscount !== MIN_QUALIFYING_DISCOUNT_PCT) params.set('min_discount', String(view.minDiscount))
...
export function resolveHotelResultsView(source: SearchParamSource): HotelResultsViewState | null {
  ...
  const minDiscount = readInteger('min_discount', MIN_QUALIFYING_DISCOUNT_PCT)

 ...
 * minimum-history guarantee ("below 3 snapshots never flag") are unit-testable.
...
export const MIN_SNAPSHOTS = 3        // below this history depth, never flag
...
export function evaluateDeal(stats: DealStats): DealDecision {
  ...
  // the "below 3 snapshots never flag" guarantee.

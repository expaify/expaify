...
<body style="margin:0;padding:0;background:#FAF7F2;font-family:system-ui,-apple-system,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#FAF7F2;padding:40px 20px;">
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#fff;border-radius:16px;overflow:hidden;border:1px solid #E8E2D8;">
        <!-- Header -->
        <tr>
          <td style="padding:32px 40px 24px;border-bottom:1px solid #E8E2D8;">
            <span style="font-size:20px;font-weight:700;color:#141210;letter-spacing:0;">
        ...
        <tr>
          <td style="padding:32px 40px;">
            <h1 style="margin:0 0 8px;font-size:22px;font-weight:700;color:#141210;letter-spacing:0;">Your sign-in link</h1>
            <p style="margin:0 0 28px;font-size:15px;color:#5C5852;line-height:1.5;">
        ...
        <!-- Footer -->
        <tr>
          <td style="padding:20px 40px;background:#FAF7F2;border-top:1px solid #E8E2D8;">
            <p style="margin:0;font-size:12px;color:#767168;">

...
import { NO_QUIET_STAY_EVIDENCE, QuietStayEvidenceLedger } from '@/app/components/ui/QuietStayEvidenceLedger'
...
async function DealScoreSection({ deal }: { deal: DealRow }) {
  ...
  if (pricePoints.length > 0) {
    const offer = {
      ...
      deeplink: '',
      source: 'expaify',
      documentReadiness: notProvidedHotelDocumentReadiness('expaify'),
    }

      ...
      <main className="mx-auto w-full max-w-[1080px] px-4 py-5 sm:px-6 sm:py-8">
        ...
        {isExpired ? (
          ...
          <section data-hotel-decision-section="supporting_evidence" data-hotel-decision-position="5" aria-labelledby="supporting-title" className="rounded-[var(--radius-card)] border border-[color:var(--border)] bg-[color:var(--bg-surface)] p-4 sm:p-6">
            ...
            {/* Deal score details remain above supporting fit evidence in the decision sequence. */}
            <QuietStayEvidenceLedger evidence={NO_QUIET_STAY_EVIDENCE} />
            <PropertyPhoto src={deal.photo_url} size="detail" loading="eager" />
            {/* <img src={deal.photo_url} is rendered through PropertyPhoto for its accessible fallback. */}
            {/* Primary action zone */}

...
function HotelHandoffReview({
  ...
  const feeHandoffCopy = partner.named
    ? `Mandatory property fees are not confirmed. On ${partner.label}, check the final total and any amount due at the property before you continue.`
  ...
  const feeAccessibleClause = partner.named
    ? `Mandatory property fees are not confirmed. Check the final total and any amount due at the property on ${partner.label}.`

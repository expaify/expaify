...
describe('BookingFlow fare context review', () => {
  ...
  it('deduplicates guest identity retries and focuses the completed status once', () => {
    const pendingRef = { current: false };
    expect(beginHotelGuestIdentityCheck(pendingRef)).toBe(true);
    expect(beginHotelGuestIdentityCheck(pendingRef)).toBe(false);

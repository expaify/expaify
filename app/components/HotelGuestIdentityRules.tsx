...
import type { HotelAdmissionPresentation, SupplierAdmissionStatement } from '@/lib/types'
import type { Ref } from 'react'

export type GuestIdentityDimensionState =
  | 'confirmed'
  | 'conditional'
  | 'not_required'
  | 'not_established'
...
export type GuestIdentityAffectedParty =
  | 'lead_guest'
  | 'cardholder'
  | 'all_occupants'
  | 'other'
...
function validStatements(statements: readonly SupplierAdmissionStatement[]) {
...
export function deriveGuestIdentityPresentation(
  ...
  const empty = {
    ...
    statements: [] as readonly SupplierAdmissionStatement[],
    sourceLabel,
  }

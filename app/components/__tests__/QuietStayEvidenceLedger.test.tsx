...
describe('QuietStayEvidenceLedger', () => {
  ...
  it('adds the bounded cue inside the existing result link without a new control', () => {
    ...
    expect(populated).toContain('aria-label="View deal: Example Hotel. Quiet-stay evidence available: Property. EV charging: Unknown. This provider did not return usable on-property charging details."')

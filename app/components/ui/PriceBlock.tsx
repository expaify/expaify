      ...
      <span
        className={
          display
            ...
            : "font-display text-2xl font-bold leading-none text-[color:var(--primary)]"
        }
      >
        {formatMoney(dealPrice)}
      </span>
      {perNight ? (
        <span className="text-sm leading-none text-[color:var(--ink-faint)]">/ night</span>
      ) : null}
      <span className={`${display ? "text-base" : "text-base"} leading-none text-[color:var(--ink-faint)] line-through`}>

...
export default async function LandingPage() {
  ...
  return (
    <div className="theme-dark-preview">
      <div className="dark-preview-atmosphere" aria-hidden="true" />
      <div className="dark-preview-content">
      <LandingNav />

      <main>
        {/* ── Hero ──────────────────────────────────────── */}
        <section className="dark-preview-reveal mx-auto max-w-[1140px] px-5 pb-20 pt-16">
              ...
              {[
                {
                  ...
                  body: `Our pipeline snapshots hotel rates across ${TRACKED_MARKETS.length} destinations every 24 hours, building a 60-day price history per property.`,
                },
                {
                  n: '02',
      ...
      {/* ── Footer ──────────────────────────────────── */}
      <footer className="border-t border-[color:var(--line-ivory)] bg-[color:var(--bg)] py-16">
        <div className="mx-auto max-w-[1140px] px-5">
